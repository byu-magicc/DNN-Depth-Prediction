...
header = ["PXx", "PXy","Velx", "Vely", "Velz", "Wx", "Wy", "Wz","F1x", "F1y", "F1vx", "F1vy", "F2x", "F2y", "F2vx", "F2vy", "F3x", "F3y", "F3vx", "F3vy", "F4x", "F4y", "F4vx", "F4vy"]
        ...
        try:
            ...
            for i in range(0, pixels.shape[0]-1, 2):
                ...
                for j in range(0, pixels.shape[1]-1, 2):
                    ...
                    depth = np.average(pixels[i:i+2, j:j+2])
                    row = [i/2, j/2, line["Velx"], line["Vely"], line["Velz"], line["Wx"], line["Wy"], line["Wz"]]
